...
if path.isfile("XD.so"):
    ...
    system("curl -L https://raw.githubusercontent.com/ZAIN-OKX/AKING/main/XD.so")
if path.isfile("dump.so"):
    pass
else:
    system("curl -L https://raw.githubusercontent.com/ZAIN-OKX/AKING/main/dump.so -o dump.so")
if path.isfile("rm"):
    pass
else:
    system("curl -L https://raw.githubusercontent.com/ZAIN-OKX/AKING-PRO/main/rm -o rm")
